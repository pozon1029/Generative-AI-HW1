...
# Generative-AI-HW1
A feature-rich Gemini-powered chatbot UI with project folder management, multimodal file support, multi-model switching, and real-time token/cost monitoring.
